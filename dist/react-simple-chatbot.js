! function (e, t) {
	"object" == typeof exports && "object" == typeof module ? module.exports = t(require("styled-components")) : "function" == typeof define && define.amd ? define(["styled-components"], t) : "object" == typeof exports ? exports.ReactSimpleChatbot = t(require("styled-components")) : e.ReactSimpleChatbot = t(e["styled-components"])
}(window, function (e) {
	return function (e) {
		function t(r) {
		...
		bt.propTypes = {
			...
			speechSynthesis: ie.a.shape({
				enable: ie.a.bool,
				lang: ie.a.string,
				voice: ie.a.instanceOf(window.SpeechSynthesisVoice)
			}),
